...
difference() {
    ...
    // notch
    translate([182,40,spar_w])
      rotate([0,0,-45])
        cube([200,150,copter_w-spar_w*2]);
}

// back prop
translate([copter_l-big_prop_r*2+15,copter_h-(spar_h-big_prop_h)/2,big_prop_r+spar_w])
  rotate([90,0,0])
    cylinder(big_prop_h, big_prop_r, big_prop_r);
