...
module fwing(h, w, orientation=0) {
  ...
  l = 25;
  X = [// L, dx,     dy,     dz,      R
      [f*31, 0.001,  h,      l-9,    -ATTACK, 0],
      [f*28, w*100,  h-3,    l-5,    -ATTACK, 0],
      [f*20, w*122,  h-12,    l+5,    -ATTACK, -THICKEN/2], 
      [f*10, w*128,  h/2+10, l+15,     0,       -THICKEN],
      [f*15, w*122,  0,      l+7,     0,       -THICKEN],  
      [f*27, w*100,  -14,    l-10,    -ATTACK, -THICKEN/2],
      [f*30, w*35,   -18,    l-15,    -ATTACK, 0]
   ];
...
module bwing(h, w, orientation=0) {
  ...
  l = 25;
  X = [// L, dx,     dy,     dz,      R
      [f*8,  w*102,  h/8,    l+28,     0,      -THICKEN],
      [f*20, w*100,  -10,    l+14,     0,    -THICKEN],  
      [f*28, w*90,   -14,    l+4,    -ATTACK/4, -THICKEN/2],
      [f*30, w*10,   -18,    l,    -ATTACK/4, 0]
   ];
  Xs = nSpline(X, 150); // interpolate wing data
  sweep(gen_dat(Xs,orientation,100));
}
